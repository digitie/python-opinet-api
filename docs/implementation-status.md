...
- The normalized station detail contract consumed by `python-krtour-map` is kept stable: `provider_station_id`, `provider_station_name`, `coordinate`, `prices`, and `raw`.
